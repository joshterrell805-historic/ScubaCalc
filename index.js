...
function calculate()
{
   ...
   {
      setError(
         "please wait a second or so for the decompression tables "
   ...
   {
      setError('value for dive-1 minutes must be greater than or equal to 1 and '
   ...
   setResults('After dive 1, you will be in group '
      + String.fromCharCode('A'.charCodeAt(0) + group) + '.',
      note, warning
   );
   ...
   function setError(str, internal)
   {
      ...
      error.html(
         (internal ? 'Sorry, there has been an internal error. '
